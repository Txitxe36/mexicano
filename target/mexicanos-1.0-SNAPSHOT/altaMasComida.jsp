...
<h1 class="ml-5">Alta Más Comida</h1>
<p class="ml-5">Ingrese una nueva receta al sistema en la sección de Mas Recetas</p>

<form class="user" action="SvMasComida" method="POST">
