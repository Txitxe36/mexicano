...
@WebServlet(name = "SvEditarComida", urlPatterns = {"/SvEditarComida"})
public class SvEditarComida extends HttpServlet {
   ...
   Controladora control = new Controladora();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        response.sendRedirect("editarComida.jsp");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Comida comida = (Comida)request.getSession().getAttribute("comidaEditar");
