...
<head>
    <% 
       MasComida masComida = (MasComida)request.getSession().getAttribute("masComidaTraer");
       %>
    <meta charset="UTF-8">
    <title><%= masComida.getNombre()%> - Fogones mexicanos</title>
    ...
    <!--EMPIEZA EL HEADER-->
       ...
       <!--TERMINA EL HEADER-->
        ...
        <section class="container-nueva">
          <h1 class="text-center titulo mt-5 mb-5" name="nombreMasComida"><%= masComida.getNombre()%>!!!</h1>
          <p class=" subtitulo text-center m-5"><%= masComida.getDescripcion()%></p>
            <div class="formulario row">
                
                <div class="imagen col-3">
                  <img src="<%= masComida.getRuta()%>" width="300px" height="260px" alt="" srcset="">
                </div>
                ...
                <div class="lista col-3">  
                  <ul>    
                   ...
                   <li>Sal al gusto</li>-->
                      <li>  <%= masComida.getIngredientes()%></li>
                  </ul>
                </div>
            </div>
            ...
            <div class="row preparacion mt-4">
              <div class="row detalle ">
                ...
                <div class="col-3 text-center">
                  ...
                  <p><%= masComida.getTiempo()%></<p>
                </div>
              </div>            
              <div class="row detalle">
                  <div class="col-4 text-center">
                    <p><b>PLATO</b>  </p>
                    <p><%= masComida.getTipo()%></p>
                  </div>
                  <div class="col-4 text-center">
                    <p> <b>CALORIAS</b> </p>
                    <p><%= masComida.getKcal()%></p>
                  </div>
                  <div class="col text-center">
                    <p> <b>PORCIONES</b> </p>
                    <p><%= masComida.getPorciones()%></p>
                  </div>
                </div>             
            </div>
            ...
            <div class="row preparacion">
              <div class="pasos col-12 text-center">
                ...
                <p>Una vez que la sopa comience a hervir, cocinar a fuego bajo y cubre la cacerola. Cocina por 10 minutos a fuego lento. Por último, ya pasado este tiempo, añade las espinacas y revuelve, luego cocina por 5 minutos más. Retira la cacerola del fuego, ya que no quieres que las espinacas se cocinen demasiado. ¡Sirve en tazones pequeños y disfruta de tu Sopa de Pasta con espinacas!</p> 
                 -->  
                 <p><%= masComida.getModopreparacion()%></p>
                </div>
            </div>
